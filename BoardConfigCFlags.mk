...
ifeq ($(BOARD_HDMI_PRIMARY_DISPLAY), true)
    LOCAL_CFLAGS += -DHDMI_PRIMARY_DISPLAY
endif
else
...
ifeq ($(BOARD_USES_EXYNOS_FIMG4X), true)
    LOCAL_CFLAGS += -DUSES_FIMG4X_BLIT
else
ifeq ($(BOARD_USES_EXYNOS_FIMG5X), true)
    LOCAL_CFLAGS += -DUSES_FIMG5X_BLIT
endif
endif
